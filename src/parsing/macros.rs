//! Convenient macros for mathematical expression creation and parsing
//!
//! Provides ergonomic macros that make the library delightful to use.
...
macro_rules! calculus {
    ...
    (integral: $expr:expr, $var:ident) => {
        $crate::core::Expression::integral($expr, $crate::core::Symbol::new(stringify!($var)), None)
    };
