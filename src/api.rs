...
impl MathHook {
    ...
    fn extract_variables(&self, equation: &Expression) -> Vec<Symbol> {
        ...
        variables.into_iter().map(|name| Symbol::new(&name)).collect()
    }
}
...
mod tests {
    ...
    fn test_educational_api() {
        ...
        assert_eq!(edu_result.difficulty_level, educational::DifficultyLevel::Intermediate);
    }
