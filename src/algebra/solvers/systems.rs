...
impl SystemEquationSolver for SystemSolver {
    ...
    fn solve_system_with_explanation(&self, equations: &[Expression], variables: &[Symbol]) -> (SolverResult, StepByStepExplanation) {
        ...
        let steps = vec![
            Step::new("System Analysis", format!("Solving system of {} equations in {} variables", equations.len(), variables.len())),
...
impl SystemSolver {
    ...
    fn solve_2x2_system(&self, eq1: &Expression, eq2: &Expression, var1: &Symbol, var2: &Symbol) -> SolverResult {
    ...
    fn extract_linear_coefficients_2var(&self, equation: &Expression, var1: &Symbol, var2: &Symbol) -> (Expression, Expression, Expression) {
        match equation {
            ...
            _ => (Expression::integer(0), Expression::integer(0), equation.clone())
        }
    }
    
    /// Solve 2x2 system using Cramer's rule
    fn solve_using_cramers_rule(&self, a1: Expression, b1: Expression, c1: Expression, 
                                a2: Expression, b2: Expression, c2: Expression) -> SolverResult {
        // System: a1*x + b1*y = -c1
        //         a2*x + b2*y = -c2
            ...
            (Expression::Number(Number::SmallInt(a1_val)),
             ...
             Expression::Number(Number::SmallInt(c2_val))) => {
                ...
                if det == 0 {
                    ...
                    if self.are_equations_proportional(*a1_val, *b1_val, *c1_val, *a2_val, *b2_val, *c2_val) {
    ...
    fn are_equations_proportional(&self, a1: i64, b1: i64, c1: i64, a2: i64, b2: i64, c2: i64) -> bool {
