...
impl DerivativeWithSteps for Expression {
    fn derivative_with_steps(&self, variable: &Symbol, order: u32) -> StepByStepExplanation {
        if order == 0 {
            let steps = vec![Step {
                title: "Zero Order Derivative".to_owned(),
                description: "The 0th derivative of a function is the function itself".to_owned(),
                expression: self.clone(),
                rule_applied: "Identity".to_owned(),
                latex: Some(self.to_latex(None).unwrap_or_else(|_| "f(x)".to_owned())),
            }];
            return StepByStepExplanation {
                ...
                steps,
                total_steps: 1,
                rules_used: vec!["Identity".to_owned()],
            };
        }
        ...
        for n in 1..=order {
            ...
            if n < order {
                steps.push(Step {
                    ...
                    rule_applied: "Intermediate".to_owned(),
                    latex: Some(current.to_latex(None).unwrap_or_else(|_| "f(x)".to_owned())),
                });
            }
        }
        ...
        StepByStepExplanation {
            ...
            rules_used: vec!["Differentiation".to_owned()],
        }
    }
}
    ...
    match expr {
        ...
        _ => {
            ...
            StepByStepExplanation {
                ...
                steps: vec![Step {
                    title: "Compute Derivative".to_owned(),
                    description: format!(
                        "d/d{}({}) = {}",
                        variable.name(),
                        format_expr(expr),
                    ...
                    rule_applied: "General Differentiation".to_owned(),
                    latex: Some(
                        result
                            .to_latex(None)
                ...
                total_steps: 1,
                rules_used: vec!["General Differentiation".to_owned()],
            }
        }
    }
}
...
fn explain_general_power_derivative(
    ...
    StepByStepExplanation {
        ...
        final_expression: result.clone(),
        steps: vec![Step {
            title: "Apply General Power Rule".to_owned(),
            description: format!(
                "d/d{}({}) = {}",
                variable.name(),
                format_expr(&expr),
            ...
            expression: result.clone(),
            rule_applied: "General Power Rule".to_owned(),
            latex: Some(
                result
                    .to_latex(None)
                    .unwrap_or_else(|_| "result".to_owned()),
        ...
        total_steps: 1,
        rules_used: vec!["General Power Rule".to_owned()],
    }
}
...
fn explain_general_product_rule(
    ...
    StepByStepExplanation {
        ...
        final_expression: result.clone(),
        steps: vec![Step {
            title: "Apply General Product Rule".to_owned(),
            description: format!(
                "d/d{}({}) = {}",
                variable.name(),
                format_expr(&expr),
            ...
            expression: result.clone(),
            rule_applied: "General Product Rule".to_owned(),
            latex: Some(
                result
                    .to_latex(None)
                    .unwrap_or_else(|_| "result".to_owned()),
        ...
        total_steps: 1,
        rules_used: vec!["General Product Rule".to_owned()],
    }
}
...
fn explain_general_function_derivative(
    ...
    StepByStepExplanation {
        ...
        final_expression: result.clone(),
        steps: vec![Step {
            title: "Apply Function Derivative".to_owned(),
            description: format!(
                "d/d{}({}) = {}",
                variable.name(),
                format_expr(&expr),
            ...
            expression: result.clone(),
            rule_applied: "Function Derivative".to_owned(),
            latex: Some(
                result
                    .to_latex(None)
                    .unwrap_or_else(|_| "result".to_owned()),
        ...
        total_steps: 1,
        rules_used: vec!["Function Derivative".to_owned()],
    }
}
