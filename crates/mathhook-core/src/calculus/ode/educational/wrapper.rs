...
use crate::calculus::ode::educational::steps::{ODEPhase, ODESolutionStep, ODEStepFactory};
...
impl EducationalODESolver {
    ...
    pub fn solve_separable_with_steps(
        ...
        let separation_step = ODEStepFactory::separation(rhs, rhs, "g(x)", "h(y)");
        ...
        let integration_right =
            ODEStepFactory::integration(rhs, &Expression::integer(1), independent, "right");
        ...
        let explanation = ODEExplanation::new(
            ...
            steps,
            "Separable".to_owned(),
            "Variable separation followed by integration".to_owned(),
        );
    ...
    pub fn solve_linear_with_steps(
        ...
        let explanation = ODEExplanation::new(
            ...
            "Integrating factor method".to_owned(),
        );
...
impl crate::algebra::solvers::EquationSolver for EducationalODESolver {
    ...
    fn solve_with_explanation(
        ...
        let steps = vec![
            ...
            Step::new("Status", "ODE solving integration in progress (Wave 1-INT)"),
        ];
...
mod tests {
    ...
    fn test_explanation_human_readable() {
        ...
        let solver = EducationalODESolver::new();
        let explanation = solver
            .solve_separable_with_steps(&rhs, &y, &x, None)
            .unwrap();
    ...
    fn test_steps_by_phase() {
        ...
        assert!(
            !integration_steps.is_empty(),
            "Should have integration steps"
        );
    }
}
