...
impl ODEStepFactory {
    ...
    pub fn detection(
        ...
        ODESolutionStepBuilder::new()
            ...
            .metadata("ode_type".to_string(), ode_type.to_string())
            .build()
    ...
    pub fn separation(
        ...
        ODESolutionStepBuilder::new()
            .step_id("separate_variables".to_string())
            .phase(ODEPhase::Transformation)
            .title("Separate Variables".to_string())
            .description(format!(
                "Rewrite the equation to separate x and y terms: dy/h(y) = g(x)dx where g(x) = {} and h(y) = {}",
                g_x, h_y
            ))
            .justification("Variable separation allows us to integrate each side independently".to_string())
            .before(original.clone())
            .after(separated.clone())
            .metadata("g_x".to_string(), g_x.to_string())
            .metadata("h_y".to_string(), h_y.to_string())
            .build()
    ...
    pub fn integration(
        ...
        ODESolutionStepBuilder::new()
            ...
            .justification("Integration yields the antiderivative plus constant of integration".to_string())
            .before(integrand.clone())
            .after(result.clone())
            .metadata("variable".to_string(), variable.name().to_string())
            .metadata("side".to_string(), side.to_string())
            .build()
    ...
    pub fn solution_construction(
        ...
        ODESolutionStepBuilder::new()
            .step_id("construct_solution".to_string())
            .phase(ODEPhase::Solution)
            .title("Construct Final Solution".to_string())
            .description(format!("Solve for the dependent variable using {}", method))
            .justification("Rearranging the integrated equation to express y explicitly in terms of x".to_string())
            .before(implicit.clone())
            .after(explicit.clone())
            .metadata("method".to_string(), method.to_string())
            .build()
    ...
    pub fn verification(
        ...
        let status = if verification_result { "verified" } else { "pending" };
        ODESolutionStepBuilder::new()
            .step_id("verify_solution".to_string())
            .phase(ODEPhase::Verification)
            .title("Verify Solution".to_string())
            .description(format!(
                "Substitute the solution back into the original equation to verify correctness: {}",
                status
            ))
            .justification("Verification confirms the solution satisfies the differential equation".to_string())
            .before(solution.clone())
            .after(original_ode.clone())
            .metadata("verified".to_string(), verification_result.to_string())
            .build()
...
mod tests {
    ...
    fn test_detection_factory() {
        ...
        assert_eq!(step.metadata.get("ode_type"), Some(&"separable".to_string()));
    }
