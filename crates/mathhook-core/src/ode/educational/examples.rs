...
impl ODEExamples {
    ...
    pub fn separable_simple() -> ODEExplanation {
        ...
        ODEExplanation::new(
            ...
            steps,
            "Separable".to_string(),
            "Variable separation: Separate variables and integrate both sides".to_string(),
        )
    }
    ...
    pub fn exponential_growth() -> ODEExplanation {
        ...
        ODEExplanation::new(
            solution,
            steps,
            "Separable (Exponential Growth)".to_string(),
            "Separation and integration yields exponential solution".to_string(),
        )
    }
    ...
    pub fn linear_first_order() -> ODEExplanation {
        ...
        ODEExplanation::new(
            ...
            "Integrating factor method: μ(x) = e^(∫P(x)dx)".to_string(),
        )
    }
    ...
    pub fn product_separable() -> ODEExplanation {
        ...
        ODEExplanation::new(
            solution,
            steps,
            "Separable (Product Form)".to_string(),
            "Separate and integrate: ln|y| = x²/2 + C → y = C·e^(x²/2)".to_string(),
        )
    }
    ...
    pub fn initial_value_problem() -> ODEExplanation {
        ...
        ODEExplanation::new(
            solution,
            steps,
            "Initial Value Problem".to_string(),
            "Solve general solution, then apply initial condition to find constant".to_string(),
        )
    }
