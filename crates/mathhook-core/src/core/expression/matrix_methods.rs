        ...
        match self {
            ...
            Expression::Mul(factors) => {
                ...
                if all_matrices && factors.len() > 1 {
                    let transposed_factors: Vec<Expression> = factors
                        .iter()
                        .rev()
                        .map(|f| f.transpose())
                        .collect();
            ...
            Expression::Matrix(matrix) => {
                use crate::matrix::CoreMatrixOps;
    ...
    pub fn inverse(&self) -> Expression {
        match self {
            ...
            Expression::Mul(factors) => {
                ...
                if all_matrices && factors.len() > 1 {
                    let inverse_factors: Vec<Expression> = factors
                        .iter()
                        .rev()
                        .map(|f| f.inverse())
                        .collect();
...
mod tests {
    ...
    fn test_function_expression_commutativity() {
        ...
        assert_eq!(a_t.commutativity(), Commutativity::Noncommutative,
