...
impl StepByStep for Expression {
    ...
    fn explain_simplification(&self) -> StepByStepExplanation {
        ...
        StepByStepExplanation {
            ...
            steps,
            total_steps,
            rules_used: vec!["Simplification".to_string()],
        }
    }
    ...
    */
    ...
    fn explain_expansion(&self) -> StepByStepExplanation {
        ...
        if let Some((expanded, method_steps)) = expand_expression(&self) {
            ...
            steps.push(Step {
                title: "Final Expanded Form".to_string(),
            ...
            StepByStepExplanation {
                ...
                steps,
                total_steps,
                rules_used: vec!["Expansion".to_string()],
            }
        } else {
            steps.push(Step {
                title: "Already Expanded".to_string(),
                description: "Expression is already in expanded form".to_string(),
                expression: self.clone(),
                rule_applied: "None".to_string(),
                latex: None,
            });
    ...
    */
    ...
    fn explain_factorization(&self) -> StepByStepExplanation {
        ...
        if let Some((factored, method_steps)) = factor_expression(&self) {
            steps.extend(method_steps);
            steps.push(Step {
                title: "Final Factored Form".to_string(),
            ...
            StepByStepExplanation {
                ...
                steps,
                total_steps,
                rules_used: vec!["Factorization".to_string()],
            }
        } else {
            steps.push(Step {
                title: "Already Factored".to_string(),
                description: "Expression cannot be factored further".to_string(),
                expression: self.clone(),
                rule_applied: "None".to_string(),
                latex: None,
            });
