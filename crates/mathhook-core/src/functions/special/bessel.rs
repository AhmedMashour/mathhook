...
pub fn bessel_j(n: i32, x: &Expression) -> Expression {
    match x {
        Expression::Number(Number::Integer(0)) => {
            Expression::Number(if n == 0 { Number::Integer(1) } else { Number::Integer(0) })
        }
        ...
        _ => Expression::function("bessel_j", vec![Expression::Number(Number::Integer(n as i64)), x.clone()]),
    }
}
...
pub fn bessel_y(n: i32, x: &Expression) -> Expression {
    match x {
        Expression::Number(Number::Integer(0)) => {
            Expression::function("bessel_y", vec![Expression::Number(Number::Integer(n as i64)), x.clone()])
        }
        Expression::Number(Number::Float(val)) => {
        ...
        _ => Expression::function("bessel_y", vec![Expression::Number(Number::Integer(n as i64)), x.clone()]),
    }
}
...
mod tests {
    ...
    fn test_bessel_j0_at_zero() {
        assert_eq!(bessel_j(0, &Expression::Number(Number::Integer(0))),
    ...
    fn test_bessel_jn_at_zero() {
        for n in 1..5 {
            assert_eq!(bessel_j(n, &Expression::Number(Number::Integer(0))),
                       Expression::Number(Number::Integer(0)));
        }
    }
    ...
    fn test_bessel_j0_numerical_accuracy() {
        if let Expression::Number(Number::Float(val)) = bessel_j(0, &Expression::Number(Number::Float(1.0))) {
            assert!((val - 0.7651976865579666).abs() < 1e-8, "J_0(1) = {}, expected {}", val, 0.7651976865579666);
        } else {
    ...
    fn test_bessel_j1_numerical_accuracy() {
        if let Expression::Number(Number::Float(val)) = bessel_j(1, &Expression::Number(Number::Float(1.0))) {
    ...
    fn test_bessel_y0_numerical_accuracy() {
        if let Expression::Number(Number::Float(val)) = bessel_y(0, &Expression::Number(Number::Float(1.0))) {
            assert!((val - 0.08825696421567697).abs() < 1e-8, "Y_0(1) = {}, expected {}", val, 0.08825696421567697);
        } else {
            panic!("Expected Float");
        }
    }
    ...
    fn test_bessel_y1_numerical_accuracy() {
        if let Expression::Number(Number::Float(val)) = bessel_y(1, &Expression::Number(Number::Float(1.0))) {
    ...
    fn test_bessel_recurrence_j2() {
        if let Expression::Number(Number::Float(val)) = bessel_j(2, &Expression::Number(Number::Float(2.0))) {
            assert!((val - 0.35283402861563764).abs() < 1e-8, "J_2(2) = {}, expected {}", val, 0.35283402861563764);
        } else {
            panic!("Expected Float");
        }
    }
    ...
    fn test_bessel_recurrence_y2() {
        if let Expression::Number(Number::Float(val)) = bessel_y(2, &Expression::Number(Number::Float(2.0))) {
            assert!((val + 0.6174081041906827).abs() < 1e-8, "Y_2(2) = {}, expected {}", val, -0.6174081041906827);
        } else {
            panic!("Expected Float");
        }
    }
    ...
    fn test_bessel_j_input_validation_nan() {
        if let Expression::Number(Number::Float(val)) = bessel_j(0, &Expression::Number(Number::Float(f64::NAN))) {
            assert!(val.is_nan());
        } else {
            panic!("Expected Float");
        }
    ...
    fn test_bessel_j_input_validation_infinity() {
        if let Expression::Number(Number::Float(val)) = bessel_j(0, &Expression::Number(Number::Float(f64::INFINITY))) {
            assert!(val.is_nan());
        } else {
            panic!("Expected Float");
        }
    ...
    fn test_bessel_y_zero() {
        if let Expression::Number(Number::Float(val)) = bessel_y(0, &Expression::Number(Number::Float(0.0))) {
            assert!(val.is_infinite() && val.is_sign_negative());
        } else {
            panic!("Expected Float");
        }
    ...
    fn test_bessel_j_large_argument() {
        if let Expression::Number(Number::Float(val)) = bessel_j(0, &Expression::Number(Number::Float(20.0))) {
    ...
    fn test_bessel_j_high_order() {
        if let Expression::Number(Number::Float(val)) = bessel_j(5, &Expression::Number(Number::Float(10.0))) {
            assert!((val + 0.23406).abs() < 1e-2, "J_5(10) = {}, expected approximately {}", val, -0.23406);
        } else {
            panic!("Expected Float");
        }
    }
    ...
    fn test_bessel_j_negative_x_symmetry_even() {
        ...
        if let (Expression::Number(Number::Float(vp)), Expression::Number(Number::Float(vn))) = (j_pos, j_neg) {
    ...
    fn test_bessel_j_first_zero() {
        if let Expression::Number(Number::Float(val)) = bessel_j(0, &Expression::Number(Number::Float(2.4048255577))) {
            assert!(val.abs() < 1e-6);
        } else {
            panic!("Expected Float");
        }
