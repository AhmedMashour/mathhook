        ...
        self.properties.insert(
            ...
            FunctionProperties::Elementary(Box::new(ElementaryProperties {
                ...
                antiderivative_rule: Some(AntiderivativeRule {
                    ...
                    result_template: "∫|x|dx = x|x|/2 + C".to_string(),
                ...
                special_values: vec![
                    SpecialValue {
                        ...
                        latex_explanation: "|0| = 0".to_string(),
                    },
                    SpecialValue {
                        input: "1".to_string(),
                        output: Expression::integer(1),
                        latex_explanation: "|1| = 1".to_string(),
                    },
                    SpecialValue {
                        input: "-1".to_string(),
                        output: Expression::integer(1),
                ...
                identities: Box::new(vec![
                    ...
                    MathIdentity {
                        ...
                        conditions: vec!["a, b ∈ ℂ".to_string()],
                    },
                    MathIdentity {
                        ...
                        conditions: vec!["a, b ∈ ℂ, b ≠ 0".to_string()],
                    },
                ]),
                ...
                periodicity: None,
                numerical_evaluator: Some(NumericalEvaluator::StandardLib(f64::abs)),
            })),
        );
    }
}
...
fn is_negation(terms: &[Expression]) -> bool {
    terms.len() == 2
        && matches!(terms[0], Expression::Number(Number::Integer(-1)))
}
