...
impl Default for LegendreIntelligence {
    fn default() -> Self {
        Self::new()
    }
}
        ...
        self.properties.insert(
            ...
            FunctionProperties::Polynomial(Box::new(PolynomialProperties {
                ...
                rodrigues_formula: Some(RodriguesFormula {
                    formula: "P_n(x) = (1/2^n n!) d^n/dx^n (x²-1)^n".to_owned(),
                ...
                special_values: vec![
                    ...
                    SpecialValue {
                        ...
                        latex_explanation: "P_n(1) = 1 \\text{ for all } n \\geq 0".to_owned(),
                    },
                    ...
                    SpecialValue {
                        ...
                        latex_explanation: "P_n(-1) = (-1)^n \\text{ for all } n \\geq 0".to_owned(),
                    },
                    ...
                    SpecialValue {
                        ...
                        latex_explanation: "P_n(0) = \\begin{cases} (-1)^{n/2} \\frac{(n-1)!!}{n!!} & \\text{if } n \\text{ even} \\\\ 0 & \\text{if } n \\text{ odd} \\end{cases}".to_owned(),
                    },
                ],
                ...
                antiderivative_rule: AntiderivativeRule {
                    ...
                    result_template: "∫P_n(x) dx (symbolic - orthogonal polynomial integration requires specialized techniques)".to_owned(),
