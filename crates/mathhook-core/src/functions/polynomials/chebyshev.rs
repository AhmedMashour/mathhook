        ...
        self.properties.insert(
            ...
            FunctionProperties::Polynomial(Box::new(PolynomialProperties {
                ...
                antiderivative_rule: AntiderivativeRule {
                    ...
                    result_template: "∫T_n(x) dx (symbolic - orthogonal polynomial integration requires specialized techniques)".to_string(),
        ...
        self.properties.insert(
            ...
            FunctionProperties::Polynomial(Box::new(PolynomialProperties {
                ...
                antiderivative_rule: AntiderivativeRule {
                    ...
                    result_template: "∫U_n(x) dx (symbolic - orthogonal polynomial integration requires specialized techniques)".to_string(),
                    constant_handling: ConstantOfIntegration::AddConstant,
                },
            })),
        );
