...
pub use evaluation::{EvaluationResult, FunctionEvaluator};
...
pub use traits::{
    ...
    FunctionEducator as FunctionEducatorTrait, FunctionEvaluator as FunctionEvaluatorTrait,
    FunctionIntelligence, FunctionOptimizer, IntelligenceConfig, IntelligenceFactory,
    IntelligenceReport, IssueSeverity, MetadataProvider, PropertyValidator, Reference,
    ValidationIssue, ValidationLevel, ValidationResult as TraitValidationResult, Version,
};
