...
fn has_step_containing(explanation: &mathhook_core::educational::step_by_step::StepByStepExplanation, search_term: &str) -> bool {
...
fn test_reverse_power_rule_explained() {
    ...
    assert!(has_step_containing(&explanation, "power rule") || has_step_containing(&explanation, "power"));
    assert!(has_step_containing(&explanation, "n+1") || has_step_containing(&explanation, "n + 1") || has_step_containing(&explanation, "(n+1)"));
    assert!(has_step_containing(&explanation, "3") || has_step_containing(&explanation, "exponent_plus_one"));
}
...
fn test_sum_rule_explained() {
    ...
    assert!(has_step_containing(&explanation, "sum") || has_step_containing(&explanation, "separate"));
    assert!(has_step_containing(&explanation, "each") || has_step_containing(&explanation, "term"));
    assert!(has_step_containing(&explanation, "combine") || has_step_containing(&explanation, "antiderivative"));
}
...
fn test_u_substitution_identified() {
    ...
    assert!(has_step_containing(&explanation, "u") || has_step_containing(&explanation, "substitution"));
    assert!(has_step_containing(&explanation, "du") || has_step_containing(&explanation, "derivative"));
    assert!(has_step_containing(&explanation, "back") || has_step_containing(&explanation, "substitute"));
}
...
fn test_u_substitution_shows_steps() {
    ...
    assert!(has_step_containing(&explanation, "inner") || has_step_containing(&explanation, "candidate"));
    assert!(has_step_containing(&explanation, "find") || has_step_containing(&explanation, "du"));
    assert!(has_step_containing(&explanation, "rewrite") || has_step_containing(&explanation, "substitute"));
...
fn test_integration_by_parts_formula() {
    ...
    assert!(has_step_containing(&explanation, "parts") || has_step_containing(&explanation, "product"));
    assert!(has_step_containing(&explanation, "uv") || has_step_containing(&explanation, "formula"));
...
fn test_integration_by_parts_shows_all_steps() {
    ...
    assert!(has_step_containing(&explanation, "complete") || has_step_containing(&explanation, "solution"));
}
...
fn test_definite_integral_bounds() {
    ...
    assert!(has_step_containing(&explanation, "antiderivative") || has_step_containing(&explanation, "F"));
    ...
    assert!(has_step_containing(&explanation, "difference") || has_step_containing(&explanation, "-"));
}
...
fn test_definite_integral_fundamental_theorem() {
    ...
    assert!(has_step_containing(&explanation, "fundamental") || has_step_containing(&explanation, "theorem") || has_step_containing(&explanation, "calculus"));
}
...
fn test_power_rule_mentions_exponent() {
    ...
    assert!(has_step_containing(&explanation, "3") || has_step_containing(&explanation, "exponent"));
    assert!(has_step_containing(&explanation, "4") || has_step_containing(&explanation, "n+1") || has_step_containing(&explanation, "plus"));
}
...
fn test_constant_multiple_mentioned() {
    ...
    assert!(has_step_containing(&explanation, "7") || has_step_containing(&explanation, "constant"));
}
...
fn test_explanations_have_required_minimum_steps() {
    ...
    let power_explanation = explain_power_rule(
        &Expression::symbol(x.clone()),
        &Expression::integer(2),
        &x,
    );
