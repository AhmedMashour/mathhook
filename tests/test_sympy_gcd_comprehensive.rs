//! Comprehensive SymPy GCD test cases
...
fn test_sympy_gcd_comprehensive_integers() {
    ...
    for (a, b, expected) in test_cases {
        ...
        assert_eq!(gcd, Expression::integer(expected), 
                  "GCD({}, {}) should be {}, got {}", a, b, expected, gcd);
    }
}
...
fn test_sympy_gcd_comprehensive_performance() {
    ...
    println!("🚀 Comprehensive GCD Performance: {:.2}K ops/sec", ops_per_sec / 1000.0);
