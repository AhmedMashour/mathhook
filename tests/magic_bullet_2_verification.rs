use mathhook::core::{Expression, Number, Symbol};
...
fn test_performance_optimized_constructors() {
    ...
    match single_add {
        Expression::Number(Number::SmallInt(5)) => {}
    ...
    match single_mul {
        Expression::Number(Number::SmallInt(7)) => {}
