...
# use mathhook_book::mathhook;
# use mathhook::prelude::*;
use integrals::educational::IntegrationExplanation;
...
# use mathhook_book::mathhook;
# use mathhook::prelude::*;
use mathhook::core::expression::data_types::CalculusData;
...
# use mathhook_book::mathhook;
# use mathhook::prelude::*;
use integrals::{rational, substitution, by_parts};
